<?php
// gatttool --device=4c:65:a8:dc:12:1d  --char-write-req -a 0x10 -n 0100 --listen
//set_time_limit(10);
...
$exe_command = 'gatttool -t random  -I -b 4c:65:a8:dc:12:1d';
...
fputs($pipes[0], 'connect 4c:65:a8:dc:12:1d'."\n");
sleep(2);
}
...
if ($state==12) { echo $i.' read  0x18:';
fputs($pipes[0], 'char-read-hnd 0x000e'."\n");
sleep(1);
}            	
