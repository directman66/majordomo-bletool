  ...
  if ($this->tab=='data') {
   ...
   for($i=0;$i<$total;$i++) {
    ...
    if ($this->mode=='update') {
      ...
      $old_linked_object=$properties[$i]['LINKED_OBJECT'];
      $old_linked_property=$properties[$i]['LINKED_PROPERTY'];
//╤В╨е╨╕тХитЦТ╤В╨е╨┤тХи╨│╤В╨е╨╕тХитЦС╤В╨е╨╡тХи╨▒╤В╨е╨╕тХитЦС╤В╨д╨╝╤В╨ж╨б╤В╨е╨╕тХитЦС╤В╨д╨╝╤В╨е╨з╤В╨е╨╕тХитЦС╤В╨д╨╝╤В╨е╨▒╤В╨е╨╕тХитЦС╤В╨е╨╕тХи╨е╤В╨е╨╕тХитЦС╤В╨е╨┤тХи╨▒╤В╨е╨╕тХитЦС╤В╨д╨╝╤В╨е╨▒ linked
      if ($old_linked_object && $old_linked_object!=$properties[$i]['LINKED_OBJECT'] && $old_linked_property && $old_linked_property!=$properties[$i]['LINKED_PROPERTY']) {
       removeLinkedProperty($old_linked_object, $old_linked_property, $this->name);
      }
     }///update
//╤В╨е╨╕тХитЦС╤В╨е╨╡тХи╨▒╤В╨е╨╕тХитЦС╤В╨е╨┤тХи╨╡╤В╨е╨╕тХитЦС╤В╨д╨╝╤В╨ж╨в╤В╨е╨╕тХитЦС╤В╨д╨╝╤В╨ж╨б╤В╨е╨╕тХитЦС╤В╨е╨╕тХи╨ж╤В╨е╨╕тХитЦС╤В╨д╨╝╤В╨е╨з╤В╨е╨╕тХитЦС╤В╨д╨╝╤В╨е╨▒╤В╨е╨╕тХитЦС╤В╨е╨╕тХи╨е╤В╨е╨╕тХитЦС╤В╨е╨┤тХи╨▒╤В╨е╨╕тХитЦС╤В╨д╨╝╤В╨е╨▒ linked
       if ($properties[$i]['LINKED_OBJECT'] && $properties[$i]['LINKED_PROPERTY']) {
           addLinkedProperty($properties[$i]['LINKED_OBJECT'], $properties[$i]['LINKED_PROPERTY'], $this->name);
       }
